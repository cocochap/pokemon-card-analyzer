...
import {
  charTier, RARITY_W, scarcityScore, detectEra,
  buildTargets, investmentScoreFromProfile,
...
export async function GET(req: NextRequest) {
  ...
  const investScore = investmentScoreFromProfile(charTierVal, rarityW, scarce, era, athDropPct, change7d, change30d)
